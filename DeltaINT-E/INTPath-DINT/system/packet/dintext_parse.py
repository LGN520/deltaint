    ...
    def int_process(self, pkt):
        ...
        while len(pkt) >= 1:
            ...
            if timedelta_bit == 1:
                ...
                timedelta, pkt = struct.unpack("!B%ds" % (len(pkt)-1), pkt)
                timedelta = timedelta * 128
            ...
            timedelta_bits.append(timedelta_bit)
            i += 1
        return int_headers, timedelta_bits
