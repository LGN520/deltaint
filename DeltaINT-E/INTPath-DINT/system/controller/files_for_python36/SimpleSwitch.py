...
class Processor(Iface, TProcessor):
  ...
  def process_mirroring_session_add(self, seqid, iprot, oprot):
    ...
    try:
      ...
      result.ouch = ouch
    oprot.writeMessageBegin("mirroring_session_add", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_mirroring_session_delete(self, seqid, iprot, oprot):
    ...
    try:
      ...
      result.ouch = ouch
    oprot.writeMessageBegin("mirroring_session_delete", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_mirroring_session_get(self, seqid, iprot, oprot):
    ...
    try:
      ...
      result.ouch = ouch
    oprot.writeMessageBegin("mirroring_session_get", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class mirroring_session_add_args:
  """
  Attributes:
   - mirror_id
   - config
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I32, 'mirror_id', None, None, ), # 1
    (2, TType.STRUCT, 'config', (MirroringSessionConfig, MirroringSessionConfig.thrift_spec), None, ), # 2
  )
...
class mirroring_session_add_result:
  """
  Attributes:
   - ouch
  """
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'ouch', (InvalidMirroringOperation, InvalidMirroringOperation.thrift_spec), None, ), # 1
  )
...
class mirroring_session_delete_args:
  """
  Attributes:
   - mirror_id
  """
...
class mirroring_session_delete_result:
  """
  Attributes:
   - ouch
  """
...
class mirroring_session_get_args:
  """
  Attributes:
   - mirror_id
  """
...
class mirroring_session_get_result:
  """
  Attributes:
   - success
   - ouch
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (MirroringSessionConfig, MirroringSessionConfig.thrift_spec), None, ), # 0
    (1, TType.STRUCT, 'ouch', (InvalidMirroringOperation, InvalidMirroringOperation.thrift_spec), None, ), # 1
  )
