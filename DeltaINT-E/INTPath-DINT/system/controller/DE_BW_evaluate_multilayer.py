...
leaflayernum = int(sys.argv[1])

dirname = "../packet/tmp"
filenames = ["h{}_dump.txt".format(2+(leaflayernum-1)*4+1), "h{}_dump.txt".format(2+(leaflayernum-1)*4+3)]
...
hopnum = 1+2*leaflayernum
switchnum = 2+4*leaflayernum # Device number from 1 to 9
...
print("Average bit cost of DINT-ext: {}".format(dintext_avgbit))
