...
from deltaintoc4.p4_pd_rpc.ttypes import *
...
class TableConfigure(pd_base_tests.ThriftInterfaceDataPlane):
    def __init__(self):
        ...
        pd_base_tests.ThriftInterfaceDataPlane.__init__(self, ["deltaintoc4"])
    ...
    def runTest(self):
        if test_param_get('cleanup') != True:
            ...
            matchspec0 = deltaintoc4_ipv4_lpm_match_spec_t(\
                    ipv4_hdr_dstAddr = ipv4Addr_to_i32(receiver_ip),
                    ipv4_hdr_dstAddr_prefix_length = 32)
            actnspec0 = deltaintoc4_ipv4_forward_action_spec_t(self.receiver_devport)
            ...
            #matchspec0 = deltaintoc4_set_egmeta_tbl_match_spec_t(\
            ...
            #matchspec0 = deltaintoc4_update_srcip_dstip_tbl_match_spec_t(\
            #        udp_hdr_dstPort = DINT_DSTPORT)
            ...
            #matchspec0 = deltaintoc4_update_srcport_dstport_tbl_match_spec_t(\
            #        udp_hdr_dstPort = DINT_DSTPORT)
            ...
            #matchspec0 = deltaintoc4_update_protocol_tbl_match_spec_t(\
            #        udp_hdr_dstPort = DINT_DSTPORT)
            ...
            for tmp_srcip_dstip_predicate in srcip_dstip_predicate_list:
                for tmp_srcport_dstport_predicate in srcport_dstport_predicate_list:
                    for tmp_protocol_predicate in protocol_predicate_list:
                        matchspec0 = deltaintoc4_update_latency_tbl_match_spec_t(\
            ...
            #matchspec0 = deltaintoc4_ismatch_tbl_match_spec_t(\
            ...
            for tmp_delta in range(-1 * THRESHOLD, THRESHOLD + 1):
                matchspec0 = deltaintoc4_latency_insert_tbl_match_spec_t(\
                        meta_int_srcip_dstip_predicate = 8,
                        meta_int_srcport_dstport_predicate = 8,
                        meta_int_protocol_predicate = 2,
