...
print("[Average bit cost] original INT: {}, DeltaINT-O: {}".format(int_avgbitcost, dinto_avgbitcost))
...
print("[Relative error on collected INT states] original INT: {}, DeltaINT-O: {}".format(int_finalre, dinto_finalre))
