...
print("[Average bit cost] PINT: {}, DeltaINT-O: {}".format(pint_avgbitcost, dinto_avgbitcost))

print("[Average relative error]\n PINT median list: {}\n tail list: {}\n DeltaINT-O median list: {}\n tail list: {}\n".format(\
        pint_median_final_avgre_list, pint_tail_final_avgre_list, dinto_median_final_avgre_list, dinto_tail_final_avgre_list))
