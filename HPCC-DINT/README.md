...
- `python3 plothelper.py XXX.out` to get average bit cost 
...
- In switch-node.cc and rdma-hw.cc
	+ Set is\_dint, is\_dinto, and is\_dinte accordingly
	+ For example, set is\_dint and is\_dinte as true and is\_dinto as false, and run `bash run_hpcc_dint1_wb.sh` for DeltaINT-E
